...
def parse_args():
    ...
    parser.add_argument('--path_config', default='/kaggle/working/BigColor/pretrained/config.pickle')
    parser.add_argument('--path_vgg', default='/kaggle/working/BigColor/pretrained/vgg16.pickle')
    parser.add_argument('--path_ckpt_g', default='/kaggle/working/BigColor/pretrained/G_ema_256.pth')
    parser.add_argument('--path_ckpt_d', default='/kaggle/working/BigColor/pretrained/D_256.pth')
    parser.add_argument('--path_imgnet_train', default='/kaggle/input/imgnet400c/train-400/train-400')
    parser.add_argument('--path_imgnet_val', default='/kaggle/input/imgnet400c/val-400/val-400')
